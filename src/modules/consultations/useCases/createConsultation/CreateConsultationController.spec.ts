...
describe("Create Consultation controller", () => {
  beforeAll(async () => {
    if (!connection) {
  ...
  it("Should not create consultation if user is unauthenticated", async () => {
    await request(app)
      .post("/consultations")
      .send({
  ...
  it("Should not create consultation if motive is invalid", async () => {
    await request(app)
      .post("/consultations")
      .set({ Authorization: `Bearer ${token}` })
      .send({
  ...
  it("Should not create consultation if veterinary is invalid", async () => {
    await request(app)
      .post("/consultations")
      .set({ Authorization: `Bearer ${token}` })
      .send({
